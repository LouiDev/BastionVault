...
{
    private const string AppUserModelId = "HMDSoftware.Bastion";
    private const string Extension = ".bastion";
    private const string ProgId = "Bastion.Vault.1";
    ...
    private static string ExecutablePath() =>
        Environment.ProcessPath ?? Process.GetCurrentProcess().MainModule?.FileName ?? "Bastion.exe";
}
