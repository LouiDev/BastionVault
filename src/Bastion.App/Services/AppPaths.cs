...
/// <summary>
/// The three places Bastion writes to under <c>%LOCALAPPDATA%\Bastion</c>. Nothing here ever
...
public static class AppPaths
{
    ...
    public static string Root { get; } = System.IO.Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Bastion");
