...
public sealed class AboutDialogViewModel : DialogViewModelBase<bool>
{
    ...
    public string Promise =>
        "Bastion Vault protects the contents of a vault file against someone who obtains the file. It does not protect against someone who controls this machine while the vault is open.";
}
