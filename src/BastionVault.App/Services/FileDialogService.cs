...
/// off so a shortcut is never silently resolved, and Bastion Vault adds nothing to the Windows recent
...
public sealed class FileDialogService : IFileDialogService
{
    ...
    private const string KeyFileFilter = "Bastion Vault keyfile (*.key)|*.key|All files (*.*)|*.*";
