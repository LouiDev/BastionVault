...
/// BastionVault.Core's factory for an in-memory fake so the whole UI can be driven and screenshotted
...
public partial class App : Application
{
    ...
    private static void TraceBindings(string[] args)
    {
        ...
        // never attached".
        listener.WriteLine(
            $"Bastion Vault binding trace, {DateTimeOffset.Now:yyyy-MM-dd HH:mm:ss zzz}. Warnings, if any, follow.");
        listener.Flush();
#endif
    }
