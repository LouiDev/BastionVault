...
public static class HeaderCipher
{
    ...
    /// <param name="wrapAad">The wrap AAD from <see cref="BastionVault.Core.Format.VaultHeader.BuildWrapAad"/>.</param>
    ...
    /// <param name="indexAad">The index AAD from <see cref="BastionVault.Core.Format.VaultHeader.BuildIndexAad"/>.</param>
